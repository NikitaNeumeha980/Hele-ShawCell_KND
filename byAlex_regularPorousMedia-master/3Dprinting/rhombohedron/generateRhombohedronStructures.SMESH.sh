...
SOLUTION_DIR=$(pwd)
SALOME_SCRIPT=${SOLUTION_DIR}/src/makePorousCell.GEOM.py
...
minPorosity=$(echo "scale=${scaleForFolderNames}; 0.2/1.0;" | bc -l)
maxPorosity=$(echo "scale=${scaleForFolderNames}; 0.2/1.0;" | bc -l)
porosityStep=$(echo "scale=${scaleForFolderNames}; 0.5/1.0;" | bc -l)
...
UTranslationDirectionNbTimes=7
VTranslationDirectionNbTimes=7
WTranslationDirectionNbTimes=7

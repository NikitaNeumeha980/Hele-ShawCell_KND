...
onePoreCentreOfMassFile = open(ABSOLUTE_CASE_PATH + "/centreOfMass", "w", 0)
onePoreCentreOfMass = geompy.MakeCDG(onePore)
onePoreCentreOfMassFile.write("locationInMesh (" + str(geompy.PointCoordinates(onePoreCentreOfMass)[0]) + " " + str(geompy.PointCoordinates(onePoreCentreOfMass)[1]) + " " + str(geompy.PointCoordinates(onePoreCentreOfMass)[2]) + ");")
...
#Export STL-surfaces
#geompy.ExportSTL(skeletonWall, ABSOLUTE_CASE_PATH + "/skeletonWall.stl", True, 1e-4, True)

#geompy.ExportSTL(leftSide, ABSOLUTE_CASE_PATH + "/leftSide.stl", True, 1e-4, True)
#geompy.ExportSTL(rightSide, ABSOLUTE_CASE_PATH + "/rightSide.stl", True, 1e-4, True)
#geompy.ExportSTL(oppositeSide, ABSOLUTE_CASE_PATH + "/oppositeSide.stl", True, 1e-4, True)
#geompy.ExportSTL(frontSide, ABSOLUTE_CASE_PATH + "/frontSide.stl", True, 1e-4, True)
#geompy.ExportSTL(topSide, ABSOLUTE_CASE_PATH + "/topSide.stl", True, 1e-4, True)
#geompy.ExportSTL(bottomSide, ABSOLUTE_CASE_PATH + "/bottomSide.stl", True, 1e-4, True)

#Create background-mesh box
dx = math.fabs(geompy.PointCoordinates(porousCellBoxVertexOnBottom_1)[0] - geompy.PointCoordinates(porousCellBoxVertexOnTop_3)[0])
dy = math.fabs(geompy.PointCoordinates(porousCellBoxVertexOnBottom_1)[1] - geompy.PointCoordinates(porousCellBoxVertexOnTop_3)[1])
dz = math.fabs(geompy.PointCoordinates(porousCellBoxVertexOnBottom_1)[2] - geompy.PointCoordinates(porousCellBoxVertexOnTop_3)[2])

backgroundMeshBoxVertex_1 = geompy.MakeVertex(
    geompy.PointCoordinates(porousCellBoxVertexOnBottom_1)[0] - 0.1 * dx,
    geompy.PointCoordinates(porousCellBoxVertexOnBottom_1)[1] - 0.1 * dy,
    geompy.PointCoordinates(porousCellBoxVertexOnBottom_1)[2] - 0.1 * dz
)
backgroundMeshBoxVertex_2 = geompy.MakeVertex(
    geompy.PointCoordinates(porousCellBoxVertexOnTop_3)[0] + 0.1 * dx,
    geompy.PointCoordinates(porousCellBoxVertexOnTop_3)[1] + 0.1 * dy,
    geompy.PointCoordinates(porousCellBoxVertexOnTop_3)[2] + 0.1 * dz
)

backgroundMeshBox = geompy.MakeBoxTwoPnt(backgroundMeshBoxVertex_1, backgroundMeshBoxVertex_2)

geompy.addToStudy( backgroundMeshBox, 'backgroundMeshBox')

#porousCellBoxCentreOfMass = geompy.MakeCDG(porousCellBox)

#backgroundMeshBox = geompy.MakeScaleTransform(porousCellBox, porousCellBoxCentreOfMass, 2)

#rotationVector_1 = geompy.MakeVectorDXDYDZ(0, 0, onePoreCellSize)
#rotationVector_2 = geompy.MakeVectorDXDYDZ(onePoreCellSize * math.cos(0.5 * theta + 1.5 * math.pi), onePoreCellSize * math.sin(0.5 * theta + 1.5 * math.pi), 0)
#geompy.TranslateTwoPoints(rotationVector_1, grainCentreOnBottom_1, porousCellBoxCentreOfMass)
#geompy.TranslateTwoPoints(rotationVector_2, grainCentreOnBottom_1, porousCellBoxCentreOfMass)

#geompy.Rotate(backgroundMeshBox, rotationVector_1, 0.5 * theta)
#geompy.Rotate(backgroundMeshBox, rotationVector_2, 0.5 * alpha)
...
####################################################
NETGEN_2D_MaxSize = 0.05 * geompy.BasicProperties(onePore)[1] ** (1.0 / 2.0)
NETGEN_2D_MinSize = 0.001 * geompy.BasicProperties(leftSide)[1] ** (1.0 / 2.0)
NETGEN_2D_MaxSize_1 = 0.05 * geompy.BasicProperties(leftSide)[1] ** (1.0 / 2.0)
...
backgroundMesh = smesh.Mesh(backgroundMeshBox)
backgroundMeshRegular1D = backgroundMesh.Segment()
backgroundMeshLocalLength = backgroundMeshRegular1D.LocalLength( 0.5 * min([geompy.BasicProperties(allEdgesWithoutFillet[edgeIndex])[0] for edgeIndex in range(len(allEdgesWithoutFillet))]), None, 1e-6 )
backgroundMeshQuadrangle2D = backgroundMesh.Quadrangle(algo=smeshBuilder.QUADRANGLE)
backgroundMeshHexa3D = backgroundMesh.Hexahedron(algo=smeshBuilder.Hexa)

isDone = backgroundMesh.Compute()

backgroundMesh.ExportUNV( ABSOLUTE_CASE_PATH + "/backgroundMesh.unv" )
...
if(
    ...
    globalNETGEN1D2DParameters.SetMaxSize( NETGEN_2D_MaxSize )
    globalNETGEN1D2DParameters.SetMinSize( NETGEN_2D_MinSize )
    ...
    globalNETGEN1D2DParameters.SetGrowthRate( growthRate2D )
    globalNETGEN1D2DParameters.SetNbSegPerEdge( 2 )
    globalNETGEN1D2DParameters.SetNbSegPerRadius( 5 )
    ...
    #leftSideNETGEN1D2DParameters.SetMaxSize( NETGEN_2D_MaxSize )
    #leftSideNETGEN1D2DParameters.SetMinSize( NETGEN_2D_MinSize )
    ...
    #oppositeSideNETGEN1D2DParameters.SetMaxSize( NETGEN_2D_MaxSize )
    #oppositeSideNETGEN1D2DParameters.SetMinSize( NETGEN_2D_MinSize )
    ...
    #topSideNETGEN1D2DParameters.SetMaxSize( NETGEN_2D_MaxSize )
    #topSideNETGEN1D2DParameters.SetMinSize( NETGEN_2D_MinSize )
    ...
    globalLocalLength = globalRegular1D.LocalLength( globalLocalLengthSize, None, 1e-6 )

    globalNETGEN2D = porousCellMesh.Triangle(algo=smeshBuilder.NETGEN_2D)

    globalNETGEN2DParameters = globalNETGEN2D.Parameters()
    globalNETGEN2DParameters.SetMaxSize( NETGEN_2D_MaxSize )
    globalNETGEN2DParameters.SetMinSize( NETGEN_2D_MinSize )
    ...
    globalNETGEN2DParameters.SetGrowthRate( growthRate2D )
    globalNETGEN2DParameters.SetNbSegPerEdge( 2 )
    globalNETGEN2DParameters.SetNbSegPerRadius( 5 )
...
leftSideLocalLength = leftSideRegular1D.LocalLength(localLengthSize, None, 1e-6)
...
leftSideNETGEN2DParameters.SetMaxSize( NETGEN_2D_MaxSize_1 )
leftSideNETGEN2DParameters.SetMinSize( NETGEN_2D_MinSize_1 )
...
leftSideNETGEN2DParameters.SetGrowthRate( growthRate2D )
leftSideNETGEN2DParameters.SetNbSegPerEdge( 2 )
leftSideNETGEN2DParameters.SetNbSegPerRadius( 5 )
...
oppositeSideLocalLength = oppositeSideRegular1D.LocalLength(localLengthSize, None, 1e-6)
...
oppositeSideNETGEN2DParameters.SetMaxSize( NETGEN_2D_MaxSize_1 )
oppositeSideNETGEN2DParameters.SetMinSize( NETGEN_2D_MinSize_1 )
...
oppositeSideNETGEN2DParameters.SetGrowthRate( growthRate2D )
oppositeSideNETGEN2DParameters.SetNbSegPerEdge( 2 )
oppositeSideNETGEN2DParameters.SetNbSegPerRadius( 5 )
...
topSideLocalLength = topSideRegular1D.LocalLength(localLengthSize, None, 1e-6)
...
topSideNETGEN2DParameters.SetMaxSize( NETGEN_2D_MaxSize_1 )
topSideNETGEN2DParameters.SetMinSize( NETGEN_2D_MinSize_1 )
...
topSideNETGEN2DParameters.SetGrowthRate( growthRate2D )
topSideNETGEN2DParameters.SetNbSegPerEdge( 2 )
topSideNETGEN2DParameters.SetNbSegPerRadius( 5 )
...
#Sub-mesh for rightSide boundary
rightSideRegular1D = porousCellMesh.Segment(geom=rightSide)

#topSideDeflection = rightSideRegular1D.Deflection1D(1e-5)
rightSideLocalLength = rightSideRegular1D.LocalLength(localLengthSize, None, 1e-6)

rightSideNETGEN2D = porousCellMesh.Triangle(algo=smeshBuilder.NETGEN_2D,geom=rightSide)

rightSideNETGEN2DParameters = rightSideNETGEN2D.Parameters()
rightSideNETGEN2DParameters.SetMaxSize( NETGEN_2D_MaxSize_1 )
rightSideNETGEN2DParameters.SetMinSize( NETGEN_2D_MinSize_1 )
rightSideNETGEN2DParameters.SetQuadAllowed( NETGEN_2D_QuadAllowed )
rightSideNETGEN2DParameters.SetOptimize( 1 )
rightSideNETGEN2DParameters.SetFineness( 5 )
rightSideNETGEN2DParameters.SetGrowthRate( growthRate2D )
rightSideNETGEN2DParameters.SetNbSegPerEdge( 2 )
rightSideNETGEN2DParameters.SetNbSegPerRadius( 5 )
rightSideNETGEN2DParameters.SetUseSurfaceCurvature( 1 )
rightSideNETGEN2DParameters.SetSecondOrder( 0 )
rightSideNETGEN2DParameters.SetFuseEdges( 1 )

#Sub-mesh for frontSide boundary
frontSideRegular1D = porousCellMesh.Segment(geom=frontSide)

#topSideDeflection = rightSideRegular1D.Deflection1D(1e-5)
frontSideLocalLength = frontSideRegular1D.LocalLength(localLengthSize, None, 1e-6)

frontSideNETGEN2D = porousCellMesh.Triangle(algo=smeshBuilder.NETGEN_2D,geom=frontSide)

frontSideNETGEN2DParameters = frontSideNETGEN2D.Parameters()
frontSideNETGEN2DParameters.SetMaxSize( NETGEN_2D_MaxSize_1 )
frontSideNETGEN2DParameters.SetMinSize( NETGEN_2D_MinSize_1 )
frontSideNETGEN2DParameters.SetQuadAllowed( NETGEN_2D_QuadAllowed )
frontSideNETGEN2DParameters.SetOptimize( 1 )
frontSideNETGEN2DParameters.SetFineness( 5 )
frontSideNETGEN2DParameters.SetGrowthRate( growthRate2D )
frontSideNETGEN2DParameters.SetNbSegPerEdge( 2 )
frontSideNETGEN2DParameters.SetNbSegPerRadius( 5 )
frontSideNETGEN2DParameters.SetUseSurfaceCurvature( 1 )
frontSideNETGEN2DParameters.SetSecondOrder( 0 )
frontSideNETGEN2DParameters.SetFuseEdges( 1 )

#Sub-mesh for bottomSide boundary
bottomSideRegular1D = porousCellMesh.Segment(geom=bottomSide)

#topSideDeflection = rightSideRegular1D.Deflection1D(1e-5)
bottomSideLocalLength = bottomSideRegular1D.LocalLength(localLengthSize, None, 1e-6)

bottomSideNETGEN2D = porousCellMesh.Triangle(algo=smeshBuilder.NETGEN_2D,geom=bottomSide)

bottomSideNETGEN2DParameters = bottomSideNETGEN2D.Parameters()
bottomSideNETGEN2DParameters.SetMaxSize( NETGEN_2D_MaxSize_1 )
bottomSideNETGEN2DParameters.SetMinSize( NETGEN_2D_MinSize_1 )
bottomSideNETGEN2DParameters.SetQuadAllowed( NETGEN_2D_QuadAllowed )
bottomSideNETGEN2DParameters.SetOptimize( 1 )
bottomSideNETGEN2DParameters.SetFineness( 5 )
bottomSideNETGEN2DParameters.SetGrowthRate( growthRate2D )
bottomSideNETGEN2DParameters.SetNbSegPerEdge( 2 )
bottomSideNETGEN2DParameters.SetNbSegPerRadius( 5 )
bottomSideNETGEN2DParameters.SetUseSurfaceCurvature( 1 )
bottomSideNETGEN2DParameters.SetSecondOrder( 0 )
bottomSideNETGEN2DParameters.SetFuseEdges( 1 )
...
#Export STL-surfaces
backgroundMesh.ExportSTL( ABSOLUTE_CASE_PATH + "/backgroundMeshBox.stl", 1)
porousCellMesh.ExportSTL( ABSOLUTE_CASE_PATH + "/skeletonWall.stl", 1, skeletonWallBoundary)

porousCellMesh.ExportSTL( ABSOLUTE_CASE_PATH + "/leftSide.stl", 1, leftSideBoundary)
porousCellMesh.ExportSTL( ABSOLUTE_CASE_PATH + "/rightSide.stl", 1, rightSideBoundary)
porousCellMesh.ExportSTL( ABSOLUTE_CASE_PATH + "/frontSide.stl", 1, frontSideBoundary)
porousCellMesh.ExportSTL( ABSOLUTE_CASE_PATH + "/oppositeSide.stl", 1, oppositeSideBoundary)
porousCellMesh.ExportSTL( ABSOLUTE_CASE_PATH + "/topSide.stl", 1, topSideBoundary)
porousCellMesh.ExportSTL( ABSOLUTE_CASE_PATH + "/bottomSide.stl", 1, bottomSideBoundary)

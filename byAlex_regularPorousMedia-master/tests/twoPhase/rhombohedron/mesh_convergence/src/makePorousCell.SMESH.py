...
globalLocalLengthSize = 0.01 * max([geompy.BasicProperties(allEdgesWithFillet[edgeIndex])[0] for edgeIndex in range(len(allEdgesWithFillet))])
localLengthSize = 0.02 * min([geompy.BasicProperties(allEdgesWithoutFillet[edgeIndex])[0] for edgeIndex in range(len(allEdgesWithoutFillet))])

NETGEN_2D_MaxSize = 5.0 * localLengthSize
NETGEN_2D_MinSize = localLengthSize
NETGEN_2D_MaxSize_1 = 1.0 * localLengthSize
NETGEN_2D_MinSize_1 = 0.01 * localLengthSize
NETGEN_2D_QuadAllowed = 0
growthRate2D = 0.1
